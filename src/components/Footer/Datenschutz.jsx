        ...
        >
          ...
          <div className="modal-body p-4">
            ...
            <p>
              ...
              (DSGVO) ist Marcus Koch, Im Priel 1, 88138 Sigmarszell,
              Deutschland, Tel.: +491723439655, E-Mail: marcus@marcus-koch.dev.
            ...
            <p>
              ...
              anderweitig Informationen &uuml;bermitteln, erheben wir nur solche
              Daten, die Ihr Browser an den Seitenserver &uuml;bermittelt (sog.
            ...
            <p>
              ...
              Server-Logfiles nachtr&auml;glich zu &uuml;berpr&uuml;fen, sollten
            ...
            <p>
              ...
              k&ouml;nnen eine verschl&uuml;sselte Verbindung an der
            ...
            <p>
              F&uuml;r die Bereitstellung einer Online-Terminbuchungsfunktion
              nutzen wir die Dienste des folgenden Anbieters: Calendly, LLC,
              BB&amp;T Tower, 271 17th St NW, Atlanta, GA 30363, USA
            </p>

            <p>
              Zum Zwecke der Terminvergabe werden gem&auml;&szlig; Art. 6 Abs. 1
              lit. b DSGVO Vor- und Zuname sowie Mailadresse (und ggf. die
              Telefonnummer, sofern ein telefonischer Termin gew&uuml;nscht ist)
              erhoben und gem&auml;&szlig; Art. 6 Abs. 1 lit. f DSGVO auf Basis
              unseres berechtigten Interesses an einem effektiven
              Kundenmanagement und einer effizienten Terminverwaltung an den
              Anbieter &uuml;bermittelt und dort f&uuml;r die Terminorganisation
              gespeichert.
            </p>

            <p>
              Nach Abhaltung des Termins bzw. nach Ablauf des vereinbarten
              Terminzeitraums werden Ihre Daten vom Anbieter gel&ouml;scht.
            </p>
            ...
            <p>
              <b>3.2</b>&nbsp;Im Rahmen der Kontaktaufnahme mit uns (z.B. per
              Kontaktformular oder E-Mail) werden personenbezogene Daten
              erhoben. Welche Daten im Falle der Nutzung eines Kontaktformulars
              erhoben werden, ist aus dem jeweiligen Kontaktformular
              ersichtlich. Diese Daten werden ausschlie&szlig;lich zum Zweck der
              Beantwortung Ihres Anliegens bzw. f&uuml;r die Kontaktaufnahme und
            ...
            <h2>4) Seitenfunktionalit&auml;ten</h2>

            <p>
              <b>4.1</b>&nbsp;Google Web Fonts
            </p>
            ...
            <p>
              ...
              Web Fonts in ihren Browser-Cache, um Texte und Schriftarten
              korrekt anzuzeigen und stellt eine direkte Verbindung zu den
              Servern des Anbieters her. Hierbei werden bestimmte
              Browserinformationen, einschlie&szlig;lich Ihrer IP-Adresse, an
              den Anbieter &uuml;bermittelt.
            </p>
            ...
            <p>
              ...
              dann vollzogen, wenn Sie uns gem&auml;&szlig; Art. 6 Abs. 1 lit. a
            ...
            <p>
              F&uuml;r die Durchf&uuml;hrung von Online-Meetings,
              Videokonferenzen und/oder Webinaren nutzen wir diesen Anbieter:
              Zoom Video Communications Inc., 55 Almaden Blvd, Suite 600, San
              Jose, CA 95113, USA
            </p>

            <p>
              Der Anbieter verarbeitet unterschiedliche Daten, wobei der Umfang
              der verarbeiteten Daten davon abh&auml;ngt, welche Daten Sie vor
              oder w&auml;hrend der Teilnahme an einem Online-Meeting, einer
              Videokonferenz oder einem Webinar mitteilen. Es werden Ihre Daten
              als Kommunikationsteilnehmer verarbeitet und auf Servern des
              Anbieters gespeichert. Dies k&ouml;nnen insbesondere Ihre
              Anmeldedaten (Name, E-Mail-Adresse, Telefonnummer (optional) und
              Passwort) und Sitzungsdaten (Thema, Teilnehmer-IP-Adresse,
              Ger&auml;teinformationen, Beschreibung (optional)) sein.
            </p>

            <p>
              Dar&uuml;ber hinaus k&ouml;nnen Bild- und Tonbeitr&auml;ge der
              Teilnehmer sowie Spracheingaben in Chats verarbeitet werden.
              <br />
              F&uuml;r die Verarbeitung von personenbezogenen Daten, die
              f&uuml;r die Erf&uuml;llung eines Vertrages mit Ihnen erforderlich
              sind (dies gilt auch f&uuml;r Verarbeitungsvorg&auml;nge, die zur
              Durchf&uuml;hrung vorvertraglicher Ma&szlig;nahmen erforderlich
              sind), dient Art. 6 Abs. 1 lit. b DSGVO als Rechtsgrundlage.
              Soweit Sie uns eine Einwilligung zur Verarbeitung Ihrer Daten
              erteilt haben, erfolgt die Verarbeitung auf Grundlage von Art. 6
              Abs. 1 lit. a DSGVO. Eine erteilte Einwilligung k&ouml;nnen Sie
              jederzeit mit Wirkung f&uuml;r die Zukunft widerrufen.
              <br />
              Im &Uuml;brigen ist Rechtsgrundlage f&uuml;r die Datenverarbeitung
              bei der Durchf&uuml;hrung von Online-Meetings, Videokonferenzen
              oder Webinaren unser berechtigtes Interesse gem. Art. 6 Abs. 1
              lit. f DSGVO an der effektiven Durchf&uuml;hrung des
              Online-Meetings, Webinars oder der Videokonferenz.
            </p>
            ...
            <p>
              F&uuml;r die &Uuml;bermittlung von Daten in die USA beruft sich
              der Anbieter auf Standardvertragsklauseln der Europ&auml;ischen
            ...
            <p>
              ...
              (Auskunfts- und Interventionsrechte), wobei f&uuml;r die
              jeweiligen Aus&uuml;bungsvoraussetzungen auf die angef&uuml;hrte
            ...
            <p>
              ...
              ABER VORBEHALTEN, WENN WIR ZWINGENDE SCHUTZW&Uuml;RDIGE
              GR&Uuml;NDE F&Uuml;R DIE VERARBEITUNG NACHWEISEN K&Ouml;NNEN, DIE
              IHRE INTERESSEN, GRUNDRECHTE UND GRUNDFREIHEITEN &Uuml;BERWIEGEN,
              ODER WENN DIE VERARBEITUNG DER GELTENDMACHUNG, AUS&Uuml;BUNG ODER
            ...
            <p>
              ...
              nach Art. 21 Abs. 2 DSGVO aus&uuml;ben.
            </p>
